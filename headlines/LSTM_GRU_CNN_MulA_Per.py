...
# 定义模型，结合 CNN、GRU 和 LSTM 网络，并加入注意力机制
class SentimentNet(nn.Cell):
    def __init__(self, vocab_size, embedding_dim=100, hidden_size=128, num_classes=5,
                 ...
                 num_filters=128, filter_sizes=(3, 4, 5), max_len=128):
    ...
    def construct(self, x):
        ...
        # 融合 CNN 和 RNN 的特征
        combined_features = ops.concat((cnn_out, attn_out), 1)  # (batch_size, total_feature_size)
